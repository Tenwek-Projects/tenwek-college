        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 xl:gap-16">
            <div class="lg:col-span-7 xl:col-span-8">
                <section class="relative" aria-labelledby="cohs-nursing-overview" data-reveal>
                    <div class="absolute -left-4 top-0 hidden h-full w-1 rounded-full bg-gradient-to-b from-thc-cohs-coral via-thc-cohs-blue to-thc-cohs-indigo/40 sm:block" aria-hidden="true"></div>
                ...
                >
                    ...
                    <div class="p-8 sm:p-10">
                        ...
                        <div class="mt-8 rounded-xl border border-thc-cohs-coral/25 bg-thc-cohs-coral/10 px-5 py-4 sm:px-6">
                            <p class="text-xs font-bold uppercase tracking-[0.16em] text-thc-cohs-coral">Mean grade</p>
                        ...
                        <ul class="mt-4 space-y-3" role="list">
                            @foreach($admissions['subject_rules'] as $rule)
                                <li class="flex gap-3 text-base leading-relaxed text-thc-text/90">
                                    <span class="mt-1.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-thc-cohs-blue to-thc-cohs-indigo text-[10px] font-bold text-white" aria-hidden="true">✓</span>
                                    <span>{{ $rule }}</span>
                                </li>
                            @endforeach
                        </ul>
            ...
            <aside class="mt-12 lg:col-span-5 lg:mt-0 xl:col-span-4">
                <div class="lg:sticky lg:top-28" data-reveal>
                    <div class="overflow-hidden rounded-2xl border border-thc-navy/10 bg-thc-cohs-indigo text-white shadow-[var(--shadow-thc-card)]">
                        <div class="h-1.5 bg-gradient-to-r from-thc-cohs-coral via-thc-cohs-blue to-thc-cohs-sky" aria-hidden="true"></div>
                    ...
                    <div class="mt-6 overflow-hidden rounded-2xl border border-thc-navy/10 bg-white shadow-sm">
                        <div class="h-1 bg-gradient-to-r from-thc-cohs-blue to-thc-cohs-coral" aria-hidden="true"></div>
                        <div class="p-6">
