                        ...
                        <tr>
                            ...
                            <td>
                                <div class="admin-table-actions">
                                    <a href="{{ route('admin.cohs.testimonials.edit', $t) }}" class="admin-link">Edit</a>
                                    <form method="post" action="{{ route('admin.cohs.testimonials.destroy', $t) }}" class="inline" onsubmit="return confirm('Delete this testimonial?');">
                                        @csrf
                                        @method('DELETE')
