<x-layouts.admin header="COHS - Navigation">
    <div class="admin-toolbar">
        ...
        <div class="admin-toolbar-actions">
            <a href="{{ route('admin.cohs.navigation.create') }}" class="admin-btn-primary admin-btn-sm">Add item</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="admin-table-actions">
                                    <a href="{{ route('admin.cohs.navigation.edit', $item) }}" class="admin-link">Edit</a>
                                    <form method="post" action="{{ route('admin.cohs.navigation.destroy', $item) }}" class="inline" onsubmit="return confirm('Delete?');">
                                        @csrf
                                        @method('DELETE')
