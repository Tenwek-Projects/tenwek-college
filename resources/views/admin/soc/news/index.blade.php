<x-layouts.admin header="SOC - News">
    <div class="admin-toolbar">
        <div class="admin-toolbar-actions">
            <a href="{{ route('admin.soc.news.create') }}" class="admin-btn-primary admin-btn-sm">New post</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="admin-table-actions">
                                    <a href="{{ route('admin.soc.news.edit', $post) }}" class="admin-link">Edit</a>
                                    <form method="post" action="{{ route('admin.soc.news.destroy', $post) }}" class="inline" onsubmit="return confirm('Delete post?');">
                                        @csrf
                                        @method('DELETE')
